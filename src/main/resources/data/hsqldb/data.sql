...
VALUES (
'Comment externaliser des page JS', 
...
INSERT INTO COMMENT (userName, city, email, content, postId)
VALUES('TOTO', 'city', 'email', '2016-03-30 10:49:15.194  INFO 6784 --- [nio-9000-exec-1] o.s.web.servlet.DispatcherServlet', 1);

INSERT INTO COMMENT (userName, city, email, content, postId)
VALUES('TATA', 'city', 'email', '16-03-30 10:49:15.457  INFO 6784 --- [nio-9000-exec-4] org.example.ws.service.PostServiceImpl', 1)